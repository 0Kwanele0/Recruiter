  ...
  <main className={styles.container}>
   <section className={styles.showcase}>
    <div className={styles.text}>
     ...
     <p>
      Find the exact talent your company needs. Detailed search filters to help
      your requirements
     </p>
   ...
   <section className={styles.filters}>
    ...
    <div className={styles.cards}>
     ...
     <div className={styles.card}>
      ...
      <p>
       You know the exact skill your company needs; You can select the skill
       from our filter.
      </p>
     </div>
     <div className={styles.card}>
   ...
   <section className={styles.developerDo}>
    ...
    <div className={styles.action}>
     ...
     <div className={styles.text}>
      ...
      <p>
       Developers can display all their skills and field of programming they are
       operating in.
      </p>
      <h3>Display projects</h3>
      <p>
       The profile can also act as a portfolio. Devs are able to list their
       projects for recruiters to see.
      </p>
      <h3>Pin their links</h3>
      <p>
       Dislaying social media and other links is a feature that will help make
       contaction devs easy.
      </p>
      <button
       onClick={() => {
        router.push("/register");
